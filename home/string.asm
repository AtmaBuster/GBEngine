...
DEF PRINTNUM_1BYTE EQU %01
DEF PRINTNUM_2BYTE EQU %10
DEF PRINTNUM_3BYTE EQU %11
DEF F_PRINTNUM_LALIGN   EQU 2
DEF F_PRINTNUM_ZPAD     EQU 3
DEF F_PRINTNUM_BIGEND   EQU 4
DEF F_PRINTNUM_HEX      EQU 5
DEF F_PRINTNUM_COMMASEP EQU 6
; ================================================
; PrintNum
; ================================================
